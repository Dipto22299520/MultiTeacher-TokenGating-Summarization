...
BATCH_SIZE = 8  # Increased from 4 to utilize more GPU
GRADIENT_ACCUMULATION_STEPS = 4  # Reduced from 8, effective batch = 8*4 = 32 (same)
...
# Paths
OUTPUT_DIR = "./teachers/hindi_teacher"
...
def train_model():
    ...
    training_args = Seq2SeqTrainingArguments(
        ...
        generation_num_beams=6,  # Increased for teacher model quality
