"""
Knowledge Distillation: Train mT5-small student from mT5_multilingual_XLSum teacher
...
# Models
TEACHER_MODEL_PATH = "./teachers/hindi_teacher_20260306_181347/final_model"
STUDENT_MODEL_NAME = "google/mt5-small"  # mT5 small version
OUTPUT_DIR = "./students/hindi_student"

# Data
TRAIN_FILE = "./preprocessed_data/hindi/train.csv"
VAL_FILE = "./preprocessed_data/hindi/val.csv"
...
BATCH_SIZE = 32  # Increased from 16 for smaller model
GRADIENT_ACCUMULATION_STEPS = 1  # Reduced from 2, effective batch = 32*1 = 32 (same)
...
def preprocess_function(examples, tokenizer):
    """Preprocess function - add task prefix for mT5."""
    # Add "summarize: " prefix for mT5 models (CRITICAL)
...
def train_student_model():
    ...
    print("\n" + "="*80)
    print("KNOWLEDGE DISTILLATION: mT5-SMALL STUDENT FROM mT5-XLSum TEACHER")
    print("="*80)
