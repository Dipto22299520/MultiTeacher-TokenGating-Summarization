"""
Comprehensive checkpoint evaluation script for mT5 XLSum
...
# Configuration
CHECKPOINT_DIR = "mt5base_bansum_20260219_113113"
TEST_FILE = "data/test.csv"
NUM_TEST_SAMPLES = 1000  # Evaluate on 1000 samples for speed (can increase)
OUTPUT_FILE = "xlsum_checkpoint_evaluation_results.json"
...
print("="*80)
print("mT5 XLSUM CHECKPOINT EVALUATION - FINDING BEST MODEL")
print("="*80)
...
print(f"\n💾 Disk Space Analysis:")
print(f"   Total space used: {total_space:.1f} MB ({total_space/1024:.2f} GB)")
...
print(f"\n{'='*80}")
print("AUTOMATIC CLEANUP COMMANDS")
print('='*80)
print(f"""
To free up {space_to_free/1024:.2f} GB, run these commands:
...
print(f"Keep checkpoint: {best_checkpoint}")
print(f"Delete {len(other_checkpoints)} other checkpoints to free {space_to_free/1024:.2f} GB")
print('='*80)
